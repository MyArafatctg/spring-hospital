...
import com.arafat.hospital.dtos.requestDtos.*;
...
public interface PatientService {
    ...
    PatientResponse removeInsurance(PatientInsuranceRequest request);

    PatientResponse updateAppointment(PatientAppointmentUpdate request, Long patientId, Long appointmentId);
}
